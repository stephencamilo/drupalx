...
class AnnotatedClassDiscoveryTest extends DiscoveryTestBase {
  ...
  protected function setUp(): void {
    ...
    $base_directory = $this->root . '/core/backend/modules/system/tests/modules/plugin_test/src';
    $base_directory2 = $this->root . '/core/backend/modules/system/tests/modules/plugin_test_extended/src';
