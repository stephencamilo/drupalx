...
class TwigEnvironmentTest extends KernelTestBase {
  ...
  public function testTemplateClassname() {
    ...
    $name_direct = 'core/backend/modules/system/templates/container.html.twig';
  ...
  public function testCacheFilename() {
    ...
    // static cache.
    $environment = \Drupal::service('twig');
    $template_path = 'core/backend/modules/system/templates/container.html.twig';

    // A template basename greater than the constant
    // TwigPhpStorageCache::SUFFIX_SUBSTRING_LENGTH should get truncated.
    $cache = $environment->getCache();
    $long_name = 'core/backend/modules/system/templates/block--system-messages-block.html.twig';
