...
class UncaughtExceptionTest extends BrowserTestBase {
  ...
  public function testUncaughtFatalError() {
    $fatal_error = [
      ...
      '@message' => PHP_VERSION_ID >= 80000 ?
        'Drupal\error_test\Controller\ErrorTestController::Drupal\error_test\Controller\{closure}(): Argument #1 ($test) must be of type array, string given, called in ' . \Drupal::root() . '/core/backend/modules/system/tests/modules/error_test/src/Controller/ErrorTestController.php on line 65' :
        'Argument 1 passed to Drupal\error_test\Controller\ErrorTestController::Drupal\error_test\Controller\{closure}() must be of the type array, string given, called in ' . \Drupal::root() . '/core/backend/modules/system/tests/modules/error_test/src/Controller/ErrorTestController.php on line 65',
  ...
  public function testLoggerException() {
    ...
    $expected_path = \Drupal::root() . '/core/backend/modules/system/tests/modules/error_service_test/src/MonkeysInTheControlRoom.php';
    $expected_line = 59;
