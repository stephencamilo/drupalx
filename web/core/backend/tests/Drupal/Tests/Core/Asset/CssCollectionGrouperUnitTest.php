  ...
  public function testGrouper() {
    $css_assets = [
      'system.base.css' => [
        ...
        'media' => 'all',
        'preprocess' => TRUE,
        'data' => 'core/backend/modules/system/system.base.css',
      ...
      'js.module.css' => [
        ...
        'media' => 'all',
        'preprocess' => TRUE,
        'data' => 'core/backend/modules/system/js.module.css',
        'browsers' => ['IE' => TRUE, '!IE' => TRUE],
      ...
      'field.css' => [
        ...
        'media' => 'all',
        'preprocess' => TRUE,
        'data' => 'core/backend/modules/field/theme/field.css',
        'browsers' => ['IE' => TRUE, '!IE' => TRUE],
        'basename' => 'field.css',
      ],
      'external.css' => [
      ...
      'elements.css' => [
        ...
        'weight' => 0.001,
        'preprocess' => TRUE,
        'data' => 'core/frontend/themes/bartik/css/base/elements.css',
        'browsers' => ['IE' => TRUE, '!IE' => TRUE],
      ...
      'print.css' => [
        ...
        'weight' => 0.003,
        'preprocess' => TRUE,
        'data' => 'core/frontend/themes/bartik/css/print.css',
        'browsers' => ['IE' => TRUE, '!IE' => TRUE],
        'basename' => 'print.css',
      ],
    ];
