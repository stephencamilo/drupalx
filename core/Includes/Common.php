...
class Common {
   ...
   * anything.
   */
  static $drupal_cache_per_role = 0x0001;
   ...
   */
  static $drupal_cache_per_user = 0x0002;

  /**
   * The block or element can change depending on the page being viewed.
   */
  static $drupal_cache_per_page = 0x0004;

  /**
   * The block or element is the same for every user and page that it is visible.
   */
  static $drupal_cache_global = 0x0008;
  ...
  function filter_xss_admin($string) {
    return $this->filter_xss($string, ['a', 'abbr', 'acronym', 'address', 'article', 'aside', 'b', 'bdi', 'bdo', 'big', 'blockquote', 'br', 'caption', 'cite', 'code', 'col', 'colgroup', 'command', 'dd', 'del', 'details', 'dfn', 'div', 'dl', 'dt', 'em', 'figcaption', 'figure', 'footer', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'header', 'hgroup', 'hr', 'i', 'img', 'ins', 'kbd', 'li', 'mark', 'menu', 'meter', 'nav', 'ol', 'output', 'p', 'pre', 'progress', 'q', 'rp', 'rt', 'ruby', 's', 'samp', 'section', 'small', 'span', 'strong', 'sub', 'summary', 'sup', 'table', 'tbody', 'td', 'tfoot', 'th', 'thead', 'time', 'tr', 'tt', 'u', 'ul', 'var', 'wbr']);
  }
  ...
  function filter_xss($string, $allowed_tags = ['a', 'em', 'strong', 'cite', 'blockquote', 'code', 'ul', 'ol', 'li', 'dl', 'dt', 'dd']) {
    ...
    $bootstrap = new Bootstrap;
    if (!$bootstrap->drupal_validate_utf8($string)) {
      return '';
    }
