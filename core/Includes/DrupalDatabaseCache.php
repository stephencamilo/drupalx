...
class DrupalDatabaseCache implements DrupalCacheInterface {
  ...
  function getMultiple(&$cids) {
    $database = new \Core\Includes\Database\Database;
    try {
      ...
      $result = $database->db_query('SELECT cid, data, created, expire, serialized FROM {' . db_escape_table($this->bin) . '} WHERE cid IN (:cids)', array(':cids' => $cids));
      $cache = [];
